...
type
  ...
  public
    ...
    function  All(const ident: string; progress: TFindProgressProc = nil): ICoordinates;
  end; { TDLUnitAnalyzer }
...
function TDLFindAnalyzer.All(const ident: string; progress: TFindProgressProc): ICoordinates;
var
  abort          : boolean;
